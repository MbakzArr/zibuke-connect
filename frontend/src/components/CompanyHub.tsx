...
// The landing screen after login. Answers the brief's "connect the company"
// ask directly: recent announcements, and who's around. Deliberately a
// read-only overview, the place you land before diving into a channel.
    ...
    <section className="hub">
      <div className="hub-hero">
        ...
        <p className="hub-tagline">
          Everything happening across Zibuke, in one place.
        </p>
      </div>
        ...
        <div className="hub-col">
          <div className="hub-card">
            <div className="hub-card-head">
              <h3>Announcements</h3>
              {isAdmin && <NewAnnouncement onPosted={(a) => setAnnouncements((prev) => [a, ...prev])} />}
            </div>
            {announcements.length === 0 && (
              <p className="hub-muted">No announcements yet.</p>
            )}
            {announcements.map((a) => (
...
// Inline admin-only form to post an announcement from the hub.
